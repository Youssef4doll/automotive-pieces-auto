      ...
      >
        <div className="mx-auto max-w-7xl grid grid-cols-2 divide-x divide-gray-200">
          <button
            ...
            className="flex items-center gap-2.5 px-gutter py-2.5 min-h-tap text-start hover:bg-gray-50 transition-colors"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0f2352" strokeWidth="1.6" className="shrink-0">
              <path d="M3 13l1.8-5.2A2 2 0 0 1 6.7 6.4h10.6a2 2 0 0 1 1.9 1.4L21 13v5h-3v-1.6H6V18H3v-5Z" />
              <circle cx="7" cy="15" r="1" />
              <circle cx="17" cy="15" r="1" />
            </svg>
            <span className="min-w-0">
              <span className="block text-[11.5px] uppercase tracking-[.08em] text-gray-500 leading-tight">
                {t("finder.myVehicle")}
              </span>
              <span className={`block text-[15px] font-bold leading-tight truncate ${label ? "text-navy-950" : "text-navy-900"}`}>
          ...
          <Link
            href="/#magasin"
            className="flex items-center gap-2.5 px-gutter py-2.5 min-h-tap hover:bg-gray-50 transition-colors"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0f2352" strokeWidth="1.6" className="shrink-0">
            ...
            <span className="min-w-0">
              ...
              <span className="block text-[15px] font-bold text-navy-950 leading-tight truncate">
