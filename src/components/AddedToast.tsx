    ...
    >
      <div className="pointer-events-auto mx-auto max-w-lg sm:mx-0 rounded-xl bg-white border border-gray-200 shadow-[0_8px_28px_rgba(8,22,51,0.18)] p-3 motion-safe:animate-[toast-in_220ms_ease-out]">
        <div className="flex items-center gap-3">
          <span className="shrink-0 w-6 h-6 rounded-full bg-green-600 text-white flex items-center justify-center">
          ...
          <button
            ...
            className="shrink-0 w-tap h-tap -me-2 -my-2 flex items-center justify-center text-gray-400 hover:text-navy-900"
          >
